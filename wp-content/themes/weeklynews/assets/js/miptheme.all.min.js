...
// Theme Functions
"use strict";function setVideoHeights(){jQuery(document).find('iframe[src*="youtube.com"]').each(function(){jQuery(this).css("height",.56*jQuery(this).attr("width","100%").width(),"important")}),jQuery(document).find('iframe[src*="vimeo.com"]').each(function(){jQuery(this).css("height",.56*jQuery(this).attr("width","100%").width(),"important")}),jQuery(document).find('iframe[src*="dailymotion.com"]').each(function(){jQuery(this).css("height",.56*jQuery(this).attr("width","100%").width(),"important")})}var miptheme_ajax_post_views={get_post_views:function(t){jQuery.ajax({type:"POST",url:miptheme_ajax_url.ajaxurl,cache:!0,data:{action:"miptheme_ajax_update_views",post_ids:t},success:function(t,a,e){var i=jQuery.parseJSON(t);i instanceof Object&&jQuery.each(i,function(t,a){var e=".post-view-counter-"+t;jQuery(e).html(a)})},error:function(t,a,e){}})}};!function(t){function a(a,e,i){t("#weather .temp").customOpenWeather({lang:""+a,city:""+e,placeTarget:"#weather .location",units:""+i,descriptionTarget:"#weather .desc",iconTarget:"#weather i.icon",success:function(){t("#weather").show()},error:function(t){console.log(t)}})}function e(a,e,o){var r=o+" .articles",s=r+" article";t(r).removeClass("animated fadeIn"),t(s).fadeOut(700,function(){t(s).remove(),t(r).html(a).addClass("animated fadeIn"),t(r).wrapInner(t('<aside class="clearfix"></aside>'))}),t(e).hasClass("prev")?n(o):i(o),setTimeout(function(){var a=t("aside:first",t(r)).height();t(r).animate({height:a}),a>t(window).height()&&t("html, body").stop().animate({scrollTop:t(o).offset().top-30},1e3)},miptheme_ajaxpagination_timer)}function i(a){t(a+" .mip-ajax-nav a").removeClass("disabled");var e=a+" .mip-ajax-nav a.prev",i=a+" .mip-ajax-nav a.next";t(e).attr("data-index",parseInt(t(e).attr("data-index"))+1),t(i).attr("data-index",parseInt(t(i).attr("data-index"))+1),t(i).attr("data-index")==t(a).attr("data-max-pages")&&t(i).addClass("disabled")}function n(a){t(a+" .mip-ajax-nav a").removeClass("disabled");var e=a+" .mip-ajax-nav a.prev",i=a+" .mip-ajax-nav a.next";t(e).attr("data-index",parseInt(t(e).attr("data-index"))-1),t(i).attr("data-index",parseInt(t(i).attr("data-index"))-1),0==t(e).attr("data-index")&&t(e).addClass("disabled")}t(window).load(function(){t("[data-retina]").each(function(){var a=new Image;a.src=t(this).attr("data-retina"),window.devicePixelRatio>=2&&t(this).attr("src",a.src)})}),t(function(){t("nav#mobile-menu").mmenu({offCanvas:{position:"left",zposition:"front"},searchfield:!1})}),t("#menu .nav li").hover(function(){t(this).stop(!0,!0).find(".dropnav-container, .subnav-container").slideDown(100)},function(){t(this).stop(!0,!0).find(".dropnav-container, .subnav-container").hide()}),t("#menu .subnav-menu li:first-child").addClass("current"),t("#menu .subnav-menu li").hover(function(){t(this).parent().find("li").removeClass("current"),t(this).addClass("current")}),t("#search-nav-button").click(function(){t(this).delay(200).queue(function(){document.getElementById("nav-search").focus(),t(this).dequeue()})}),t(".dropdown-menu").find("form").click(function(t){t.stopPropagation()}),"undefined"!=typeof weather_widget&&weather_widget&&(""==weather_location?null===getCookie("weeklynews_weather")?t.getJSON("https://freegeoip.net/json/").done(function(t){weather_location=t.city+", "+t.country_name,setCookie("weeklynews_weather",weather_location),a(weather_lang,weather_location,weather_unit)}):a(weather_lang,getCookie("weeklynews_weather"),weather_unit):a(weather_lang,weather_location,weather_unit)),"undefined"!=typeof initCarouFredSel&&initCarouFredSel&&(t("#slider-carousel").carouFredSel({width:"100%",height:"variable",prev:"#slider-prev",next:"#slider-next",responsive:!0,transition:!0,items:{height:"variable"},swipe:{onMouse:!0,onTouch:!0},scroll:{items:1,easing:"quadratic",duration:1e3,pauseOnHover:!0},auto:{play:carouselStart,delay:carouselDelay},onCreate:function(){setTimeout(function(){t("#page-slider .bttrlazyloading").trigger("bttrlazyloading.load")},1e3),t(window).on("resize",function(){var a=t("#slider-carousel");a.parent().add(a).height(a.children().first().height()+"px")}).trigger("resize")}}).trigger("resize"),t("#slider-carousel").swipe({tap:function(a,e){t(e).click()},swipe:function(t,a,e,i,n){},threshold:50})),"undefined"!=typeof initModuleCarousel&&initModuleCarousel&&(t(".module-carousel .wrapper").carouFredSel({width:"100%",height:""+modCarHeight+"px",prev:{button:function(){return t(this).parents(".module-carousel").find(".prev")}},next:{button:function(){return t(this).parents(".module-carousel").find(".next")}},responsive:!0,transition:!0,swipe:{onMouse:!0,onTouch:!0},auto:{play:modCarAutoStart},scroll:{items:1,easing:"quadratic",duration:600,pauseOnHover:!0,onAfter:function(a){var e=t(".module-carousel .wrapper").triggerHandler("currentPosition")+1;t(".module-carousel figure .index").text(e)}}}),t(".module-carousel .wrapper").swipe({tap:function(a,e){t(e).click()},swipe:function(t,a,e,i,n){},threshold:50}),t(".module-carousel figcaption a.pix").click(function(a){a.preventDefault(),t(this).closest("figure").children("a.pix").click()})),"undefined"!=typeof initBreakingNews&&initBreakingNews&&t("#breaking-news-carousel").carouFredSel({width:"100%",height:"auto",direction:"up",items:1,scroll:{duration:1e3,onBefore:function(t){t.items.visible.children().css("opacity",0).delay(200).fadeTo(400,1),t.items.old.children().fadeTo(400,0)}}}),t(".weekly-gallery").photobox("a",{time:0}),t(".module-carousel").photobox("figure > a.pix",{time:0}),t("#article-gallery").photobox("a",{time:0}),t(".zoom-photo").photobox("a",{time:0}),t("#main").photobox("a.photobox",{time:0}),t("#archive-date-picker").datepicker({format:"mm/yyyy",viewMode:"months",minViewMode:"months"}).on("changeDate",function(t){var a=t.date.getFullYear(),e=t.date.getMonth()<8?"0"+(t.date.getMonth()+1):t.date.getMonth()+1;window.location.href="/?m="+a+e}),t(".scrollToTop").click(function(){return t("html, body").animate({scrollTop:0},800),!1}),t("#page-header").height()>0&&t("#page-header").height(t("#page-header").height());var o=t(".head-image-parallax");t(window).scroll(function(){var a=t(window).scrollTop();o.css({"background-position":"center -"+.3*a+"px"})}),setVideoHeights(),t("input, textarea").placeholder(),"undefined"!=typeof smStats&&smStats&&(smStats=new SocialMediaStats(smStats),smStatsFacebook&&smStats.facebookCount("smFacebook"),smStatsTwitter&&smStats.twitterCount("smTwitter"),smStatsLinkedIn&&smStats.linkedinCount("smLinkedin")),t(".bttrlazyloading").bttrlazyloading({backgroundcolor:"#fff",animation:"fadeIn"}),"undefined"!=typeof miptheme_smooth_scrolling&&miptheme_smooth_scrolling&&smooth_scroll(),t(".mip-ajax-nav a").click(function(a){a.preventDefault();var i=this,n=parseInt(t(this).attr("data-index")),o="#"+t(this).attr("data-container"),r=parseInt(t(o).attr("data-max-pages"));if(0!=n&&n!=r){var s=JSON.stringify(o+"-"+t(this).attr("data-index"));if(mipthemeLocalCache.exist(s))return void e(mipthemeLocalCache.get(s),i,o);var d=o+" .articles",c=d+" article";t.ajax({url:miptheme_ajax_url.ajaxurl,type:"post",data:{action:"miptheme_ajax_blocks",data_block:t(o).attr("data-block"),data_index:t(this).attr("data-index"),data_cat:t(o).attr("data-cat"),data_count:t(o).attr("data-count"),data_offset:t(o).attr("data-offset"),data_tag:t(o).attr("data-tag"),data_sort:t(o).attr("data-sort"),data_display:t(o).attr("data-display"),data_img_format_1:t(o).attr("data-img-format-1"),data_img_format_2:t(o).attr("data-img-format-2"),data_img_width_1:t(o).attr("data-img-width-1"),data_img_width_2:t(o).attr("data-img-width-2"),data_img_height_1:t(o).attr("data-img-height-1"),data_img_height_2:t(o).attr("data-img-height-2"),data_text:t(o).attr("data-text"),data_columns:t(this).attr("data-columns"),data_layout:t(this).attr("data-layout")},beforeSend:function(){t(c).addClass("ajax-opacity"),t(d).append('<span class="ajax-loading"><div class="loader">Loading...</div></span>'),t(d).wrapInner(t('<aside class="clearfix"></aside>')),t(d).css("height",""+t("aside:first",d).height()+"px")},complete:function(a,e){t(d+" .ajax-loading").remove()},success:function(t){mipthemeLocalCache.set(s,t),e(t,i,o)}})}})}(jQuery);
