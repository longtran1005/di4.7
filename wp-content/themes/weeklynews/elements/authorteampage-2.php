...
if ( ! empty( $user_query->results ) ) {
    ...
    $Layout_col_per_rows    = ( isset( $mp_weeklynews['_mp_authorteampage_template_2_columns'] ) && (bool)$mp_weeklynews['_mp_authorteampage_template_2_columns'] )   ? $mp_weeklynews['_mp_authorteampage_template_2_columns']  : '1';
    $layout_columns         = MipTheme_Util::getColumnClass( $Layout_col_per_rows );
    $gravatar_size          = 160; //MipTheme_Util::getAvatarSize( $cat_sidebar_template, $Layout_col_per_rows );
    ...
    foreach ( $user_query->results as $user ) {
        ...
        echo '<p class="desc">'. $user->description .'</p>';
