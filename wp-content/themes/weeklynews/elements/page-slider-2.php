<?php
    ...
    if ( $page_type == 'homepage' ) {
        ...
        $posts_count            = ( isset($mp_weeklynews['_mp_homepage_top_slider_slides']) && ($mp_weeklynews['_mp_homepage_top_slider_slides'] != '') )                   ?   $mp_weeklynews['_mp_homepage_top_slider_slides']            : 1;
    } else { // page
    ...
    switch ($slider_layout) {
        case 'slider-layout-3':
            $posts_per_page = ($posts_count/4)*5;
        break;
        case 'slider-layout-5':
            $posts_per_page = ($posts_count/4)*5;
        break;
        case 'slider-layout-6':
            $posts_per_page = $posts_count/4;
        break;
        default:
            $posts_per_page = $posts_count;
    }

    //$posts_per_page         = ( ($slider_layout == 'slider-layout-3')||($slider_layout == 'slider-layout-5') ) ? ($posts_count/4)*5 : $posts_count;
