<?php
    ...
    $first_image                = $first_image_attr->get_image_attr_cat02($page_sidebar_pos .'-1');
    ...
    while ( have_posts() ) : the_post();
        ...
        // format output
        echo $post_article->formatArticleStyle3($image_post_first_width, $image_post_first_height);
