<?php
    ...
    $first_image                = $first_image_attr->get_image_attr_cat05($page_sidebar_pos .'-1');

    $second_image_attr          = new MipTheme_ImageCat();
    $second_image                = $second_image_attr->get_image_attr_cat05($page_sidebar_pos .'-2');
    ...
    $shorten_text_chars         = ($cat_template_chars != 0) ? $cat_template_chars : $second_image[3];
    ...
    while ( have_posts() ) : the_post();
        ...
        //else - if not first post
            ...
            if ( $post_counter%3 == 0 ) {
                ...
                // display banner
                if ( $cat_banner_show && ( $post_counter/3 == $cat_banner_count ) ) {
                    $ad_unit        = new MipTheme_Ad();
                    $ad_unit->id    = (int)$cat_banner_show;
            ...
            // format output
            echo '<div class="col-sm-4">'. $post_article->formatArticleStyle10($image_post_second_width, $image_post_second_height) .'</div>';
