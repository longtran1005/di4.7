...
// show()
            ...
            public function _options_page() {
                ...
                if ( $this->args['menu_type'] == 'hidden' ) {
                    ...
                    // Add import demo data submenu
                    if ( empty ( $GLOBALS['admin_page_hooks']['mip_demo_installer'] ) ) {
                        ...
                        add_submenu_page( "admin.php?page=_options", "Import Demo Data" , "Import Demo Data" , 'mip_demo_installer', 'mip_demo_installer' );
