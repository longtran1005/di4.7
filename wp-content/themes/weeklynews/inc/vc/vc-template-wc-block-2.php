...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_WcBlock2' ) ) { 

    class MipTheme_VCExtendAddonClass_WcBlock2 {
        ...
        function __construct() {
            ...
            add_shortcode( 'mp_wcblock_2', array( $this, 'renderMyWcBlock2' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("WooCommerce Layout 2", 'vc_extend'),
                "base" => "mp_wcblock_2",
                "class" => "",
                "controls" => "full",
        ...
        */
        public function renderMyWcBlock2( $atts, $content = null ) {
            ...
            switch ($page_sidebar_pos) {
                case 'multi-sidebar':
                    $image_post_format_first    = array(265,265);
                    $image_post_first_width     = '265';
                    $image_post_first_height    = '265';
                    $shorten_text_chars         = 170;
                break;
                default:
                    $image_post_format_first    = array(370,370);
                    $image_post_first_width     = '370';
                    $image_post_first_height    = '370';
                    $shorten_text_chars         = 340;
                break;
            }
            ...
            if ($r->have_posts()) :
                ...
                $output .= '<section class="woocommerce woo-lay-2">'. ( ( $section_title != '' ) ? '<header><h2>'. ( ( $section_link != '' ) ? '<a href="'. $section_link .'">'. $section_title .'</a>' : $section_title ) .'</h2><span class="borderline"></span></header>' : '' );
                ...
                while ( $r->have_posts() ) :
                    ...
                    // format output
                    $output .= $post_article->formatWooArticle2($image_post_first_width, $image_post_first_height, $shorten_text_chars);
                endwhile;
                //end loop
    ...
    new MipTheme_VCExtendAddonClass_WcBlock2();
