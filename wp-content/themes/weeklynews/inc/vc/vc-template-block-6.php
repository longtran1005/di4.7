...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block6' ) ) {

    class MipTheme_VCExtendAddonClass_Block6 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_6', array( $this, 'renderMyBlock6' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 7", 'vc_extend'),
                "base" => "mp_block_6",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock6( $atts, $content = null ) {
            ...
            $first_image                = $first_image_attr->get_image_attr_block07($page_sidebar_pos .'-1');

            $second_image_attr          = new MipTheme_Image();
            $second_image                = $second_image_attr->get_image_attr_block07($page_sidebar_pos .'-2');
            ...
            $r = new WP_Query( apply_filters( 'block6_posts_args', $args ) );
            ...
            if ($r->have_posts()) :
                ...
                $post_ajax->image_post_format_second    = MipTheme_Ajax::checkImgBfi($image_post_format_second);
    ...
    new MipTheme_VCExtendAddonClass_Block6();
