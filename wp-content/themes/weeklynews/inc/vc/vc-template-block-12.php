...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block12' ) ) {

    class MipTheme_VCExtendAddonClass_Block12 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_12', array( $this, 'renderMyBlock12' ) );
            ...
            vc_map( array(
                ...
                "params" => array(
                    ...
                    array(
                        ...
                        "heading" => __("Number of columns:", 'vc_extend'),
                        "description" => "",
                        "holder" => "div",
                        "class" => ""
                    ),
                    ...
                    array(
                        ...
                        "type" => "dropdown",
                        "value" => array(
                            'Category + Title' => 'text-layout-1',
                            'Category + Title + Post meta' => 'text-layout-2',
                            'Category + Title + Post meta + Content' => 'text-layout-3',
                            'Category + Title + Content' => 'text-layout-4',
                            'Title + Post meta + Content' => 'text-layout-5',
                            'Title + Content' => 'text-layout-6',
                        ),
                        "heading" => __("Display posts as:", 'vc_extend'),
                        "description" => "",
                        "holder" => "div",
                        "class" => ""
                    ),
        ...
        */
        public function renderMyBlock12( $atts, $content = null ) {
            ...
            $image_post_format_first    = '';
            $image_post_format_second   = '';
            $image_post_first_width     = '0';
            $image_post_first_height    = '0';
            ...
            if ($r->have_posts()) :
                ...
                $post_ajax->layout_columns              = $columns_number;
                $post_ajax->layout_type                 = $text_layout;

                $output .= $post_ajax->formatBlock12();
                $output .= '</div>';

                if ( isset($post_paging) && ($post_paging == 'footer_paging') && ($r->max_num_pages > 1) ) {
                    $output .= MipTheme_Ajax::setAjaxNav( $ajax_block_id, 'ajax-nav-footer', $columns_number, $text_layout );
                }
    ...
    new MipTheme_VCExtendAddonClass_Block12();
