...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block9' ) ) {

    class MipTheme_VCExtendAddonClass_Block9 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_9', array( $this, 'renderMyBlock9' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 5", 'vc_extend'),
                "base" => "mp_block_9",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock9( $atts, $content = null ) {
            ...
            $first_image                = $first_image_attr->get_image_attr_block09($page_sidebar_pos .'-1');

            $second_image_attr          = new MipTheme_Image();
            $second_image                = $second_image_attr->get_image_attr_block09($page_sidebar_pos .'-2');
            ...
            $r = new WP_Query( apply_filters( 'block9_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block9();
