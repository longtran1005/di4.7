...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block4' ) ) {

    class MipTheme_VCExtendAddonClass_Block4 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_4', array( $this, 'renderMyBlock4' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 4", 'vc_extend'),
                "base" => "mp_block_4",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock4( $atts, $content = null ) {
            ...
            $shorten_text_chars         = $first_image[3];
            ...
            $r = new WP_Query( apply_filters( 'block4_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block4();
