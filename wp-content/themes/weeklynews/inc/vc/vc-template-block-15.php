...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block15' ) ) {

    class MipTheme_VCExtendAddonClass_Block15 {
        ...
        function __construct() {
            ...
            add_shortcode( 'mp_block_15', array( $this, 'renderMyBlock15' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 15", 'vc_extend'),
                "base" => "mp_block_15",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock15( $atts, $content = null ) {
            ...
            $image_post_second_width    = '';
            $image_post_second_height   = '';
    ...
    new MipTheme_VCExtendAddonClass_Block15();
