...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block13' ) ) {

    class MipTheme_VCExtendAddonClass_Block13 {
        ...
        function __construct() {
            ...
            add_shortcode( 'mp_block_13', array( $this, 'renderMyBlock13' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 13", 'vc_extend'),
                "base" => "mp_block_13",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock13( $atts, $content = null ) {
            ...
            $r = new WP_Query( apply_filters( 'block13_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block13();
