...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block1' ) ) {

    class MipTheme_VCExtendAddonClass_Block1 {
        ...
        function __construct() {
            ...
            add_shortcode( 'mp_block_1', array( $this, 'renderMyBlock1' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 1", 'vc_extend'),
                "base" => "mp_block_1",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock1( $atts, $content = null ) {
            ...
            $r = new WP_Query( apply_filters( 'block1_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block1();
