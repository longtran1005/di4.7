...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_WcBlock3' ) ) { 

    class MipTheme_VCExtendAddonClass_WcBlock3 {
        ...
        function __construct() {
            ...
            add_shortcode( 'mp_wcblock_3', array( $this, 'renderMyWcBlock3' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("WooCommerce Layout 3", 'vc_extend'),
                "base" => "mp_wcblock_3",
                "class" => "",
                "controls" => "full",
        ...
        */
        public function renderMyWcBlock3( $atts, $content = null ) {
            ...
            switch ($page_sidebar_pos) {
                case 'multi-sidebar':
                    $image_post_format_first    = array(167,167);
                    $image_post_first_width     = '167';
                    $image_post_first_height    = '167';
                break;
                default:
                    $image_post_format_first    = array(237,237);
                    $image_post_first_width     = '237';
                    $image_post_first_height    = '237';
                break;
            }
            ...
            if ($r->have_posts()) :
                ...
                $output .= '<section class="woocommerce news-lay-3 woo-lay-3">'. ( ( $section_title != '' ) ? '<header><h2>'. ( ( $section_link != '' ) ? '<a href="'. $section_link .'">'. $section_title .'</a>' : $section_title ) .'</h2><span class="borderline"></span></header>' : '' );
                ...
                while ( $r->have_posts() ) :
                    ...
                    // format output
                    $output .= '<div class="col-sm-4">'. $post_article->formatWooArticle3($image_post_first_width, $image_post_first_height) .'</div>';
    ...
    new MipTheme_VCExtendAddonClass_WcBlock3();
