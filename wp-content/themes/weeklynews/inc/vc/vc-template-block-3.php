...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block3' ) ) {

    class MipTheme_VCExtendAddonClass_Block3 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_3', array( $this, 'renderMyBlock3' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 3", 'vc_extend'),
                "base" => "mp_block_3",
                "class" => "",
                "controls" => "full",
    ...
    */
        ...
        */
        public function renderMyBlock3( $atts, $content = null ) {
            ...
            $first_image                = $first_image_attr->get_image_attr_block01($page_sidebar_pos .'-1');

            $second_image_attr          = new MipTheme_Image();
            $second_image                = $second_image_attr->get_image_attr_block01($page_sidebar_pos .'-2');
            ...
            $r = new WP_Query( apply_filters( 'block3_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block3();
