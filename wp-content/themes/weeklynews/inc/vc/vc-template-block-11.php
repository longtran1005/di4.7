...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block11' ) ) {

    class MipTheme_VCExtendAddonClass_Block11 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_11', array( $this, 'renderMyBlock11' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 10", 'vc_extend'),
                "base" => "mp_block_11",
                "class" => "",
                "controls" => "full",
        ...
        */
        public function renderMyBlock11( $atts, $content = null ) {
            ...
            $r = new WP_Query( apply_filters( 'block11_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block11();
