...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block14' ) ) {

    class MipTheme_VCExtendAddonClass_Block14 {
        ...
        function __construct() {
            ...
            add_shortcode( 'mp_block_14', array( $this, 'renderMyBlock14' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 14", 'vc_extend'),
                "base" => "mp_block_14",
                "class" => "",
                "controls" => "full",
    ...
    */
                    ...
                    array(
                        ...
                        "type" => "textfield",
                        "value" => '',
                        "heading" => __("Limit Text Characters for Main Picture", 'vc_extend'),
        ...
        */
        public function renderMyBlock14( $atts, $content = null ) {
            ...
            $first_image                = $first_image_attr->get_image_attr_block13($page_sidebar_pos .'-1');

            $second_image_attr          = new MipTheme_Image();
            $second_image                = $second_image_attr->get_image_attr_block13($page_sidebar_pos .'-2');
            ...
            $r = new WP_Query( apply_filters( 'block14_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block14();
