...
if ( ! class_exists( 'MipTheme_VCExtendAddonClass_Block8' ) ) {

    class MipTheme_VCExtendAddonClass_Block8 {
        function __construct() {
            // We safely integrate with VC with this hook
            add_action( 'init', array( $this, 'integrateWithVC' ) );

            // Use this when creating a shortcode addon
            add_shortcode( 'mp_block_8', array( $this, 'renderMyBlock8' ) );
        ...
        public function integrateWithVC() {
            ...
            */
            vc_map( array(
                "name" => __("Block Layout 6", 'vc_extend'),
                "base" => "mp_block_8",
                "class" => "",
                "controls" => "full",
    ...
    */
                    array(
                        ...
                        "description" => "e.g.: 3; a integer number, used to display the number of posts per page",
                        "holder" => "div",
                        "class" => ""
                    ),
        ...
        */
        public function renderMyBlock8( $atts, $content = null ) {
            ...
            $first_image                = $first_image_attr->get_image_attr_block08($page_sidebar_pos .'-1');
            ...
            $r = new WP_Query( apply_filters( 'block8_posts_args', $args ) );
    ...
    new MipTheme_VCExtendAddonClass_Block8();
